...
public class MovimentacaoTest{
    ...
    @Test
    public void instaciarMovimentoComoNaoConfirmada() {     
    ...
    public void setValorPositivo() {
        ...
        assertEquals(esperado, obtido, 0.000001);
    ...
    public void setValorNegativo() {
        ...
        final double obtido = instancia.getValor();
        assertNotEquals(invalido, obtido, 0.000001);
    ...
    public void setTipoInvalidoExcecao() {
        ...
        public static void main(String[] args) {
            ...
            movimentacaoTest.setTipoCreditoMinusculo();
            movimentacaoTest.instaciarMovimentoComoNaoConfirmada();
    }
}